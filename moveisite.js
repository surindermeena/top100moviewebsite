...
//     method: 'GET',
//     headers: {
//     'X-RapidAPI-Key': '104d911334msh9e8a367fd27873dp1dbea4jsnb6c54cfeae8a',
...
// const mybig = require('./movieData')
// const allMoviesAllData = JSON.stringify(mybig);
// console.log(allMoviesAllData);


const allMoviesAllData = [
    {
        "rank": 1,
...
let user = [...allMoviesAllData]

let openArrAM = [], openArrADM = [], openArrAniM = [], openArrBioM = [], openArrCriM = [], openArrComM = [], openArrDraM = [];
let openArrFilM = [], openArrFamM = [], openArrFantM = [], openArrHisM = [], openArrHorM = [], openArrMusM = [];
let openArrRomM = [], openArrSciM = [], openArrThrM = [], openArrWarM = [], openArrWesM = [], openArrMysM = [];
...
async function loadData() {
    ...
    user.map((a) => {
        a.genre.map((b) => {
            if (b == 'Action') { openArrAM.push(a) };
            if (b == 'Adventure') { openArrADM.push(a) };
            if (b == 'Animation') { openArrAniM.push(a) };
            if (b == 'Biography') { openArrBioM.push(a) };
            if (b == 'Crime') { openArrCriM.push(a) };
            if (b == 'Comedy') { openArrComM.push(a) };
            if (b == 'Drama') { openArrDraM.push(a) };
            if (b == 'Film-Noir') { openArrFilM.push(a) };
            if (b == 'Family') { openArrFamM.push(a) };
            if (b == 'Fantasy') { openArrFantM.push(a) };
            if (b == 'History') { openArrHisM.push(a) };
            if (b == 'Horror') { openArrHorM.push(a) };
            if (b == 'Music') { openArrMusM.push(a) };
            if (b == 'Mystery') { openArrMysM.push(a) };
            if (b == 'Romance') { openArrRomM.push(a) };
            if (b == 'Sci-Fi') { openArrSciM.push(a) };
            if (b == 'Thriller') { openArrThrM.push(a) };
            if (b == 'War') { openArrWarM.push(a) };
            if (b == 'Western') { openArrWesM.push(a) };
        });
    });
    ...
    document.getElementById("whatULike").addEventListener("search", func4Sea);
    // document.getElementById("whatULike").addEventListener("keyup", func4Sea);

    function func4Sea() {
        let movSeaInput = document.getElementById("whatULike").value.toUpperCase();
        // -------------------------------------
        ...
        ball.style.width = "80%"
        ball.style.padding = "27px 27px"
        ball.style.backgroundColor = "rgb(40, 40, 40)"
        ball.setAttribute("class", "grid-container");
        ball.style.color = "white";
        let parehead = document.createElement("p");
        parehead.innerHTML = "Movies found";
        parehead.style.fontSize = "20px";
        right.appendChild(parehead);

        let antMan = [];
        user.map((a) => {
            if (a.title.toUpperCase().indexOf(movSeaInput) > -1) {
                antMan.push(a)
            }
        });

        parehead.innerHTML = parehead.innerHTML + " ("+ `${antMan.length}` +")"
        ...
        antMan.forEach((def) => {
            ...
            newCreatDiv.className = "forPop";
            newCreatDiv.className = "forPop2";
            ...
            creaimage.style.width = "140px";
            creaimage.style.height = "200px";

            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            ball.appendChild(newCreatDiv);
    ...
    function actionMov() {
        ...
        openArrAM.forEach((def) => {
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allActionMovie").appendChild(newCreatDiv);

        });
    };
    function adventureMov() {
        ...
        openArrADM.forEach((def) => {
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allAdventureMovie").appendChild(newCreatDiv);

        });
    };
    function animationMov() {
        ...
        openArrAniM.forEach((def) => {
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allAnimationMovie").appendChild(newCreatDiv);

        });
    };
    function biographyMov() {
        ...
        openArrBioM.forEach((def) => {
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allBiographyMovie").appendChild(newCreatDiv);
    ...
    function comedyMov() {
        ...
        openArrComM.forEach((def) => {
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allComedyMovie").appendChild(newCreatDiv);
    ...
    function crimeMov() {
        ...
        openArrCriM.forEach((def) => {
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allCrimeMovie").appendChild(newCreatDiv);
    ...
    function dramaMov() {
        ...
        openArrDraM.forEach((def) => {
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allDramaMovie").appendChild(newCreatDiv);

        });
    }
    function filmnoirMov() {
        ...
        openArrFilM.forEach((def) => {
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allFilmNoirMovie").appendChild(newCreatDiv);
    ...
    function familyMov() {
        ...
        openArrFamM.forEach((def) => {
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allFamilyMovie").appendChild(newCreatDiv);

        });
    }
    function fantasyMov() {

        openArrFantM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allFantasyMovie").appendChild(newCreatDiv);

        });
    }
    function historyMov() {

        openArrHisM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allHistoryMovie").appendChild(newCreatDiv);

        });
    }
    function horrorMov() {

        openArrHorM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allHorrorMovie").appendChild(newCreatDiv);

        });
    }
    function musicMov() {

        openArrMusM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allMusicMovie").appendChild(newCreatDiv);

        });
    }
    function mysteryMov() {

        openArrMysM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allMysteryMovie").appendChild(newCreatDiv);

        });
    }
    function romanceMov() {

        openArrRomM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allRomanceMovie").appendChild(newCreatDiv);

        });
    }
    function scifiMov() {

        openArrSciM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allSciFiMovie").appendChild(newCreatDiv);

        });
    }
    function thrillerMov() {

        openArrThrM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allThrillerMovie").appendChild(newCreatDiv);

        });
    }
    function warMov() {

        openArrWarM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allWarMovie").appendChild(newCreatDiv);

        });
    }
    function westernMov() {

        openArrWesM.forEach((def) => {
            let newCreatDiv = document.createElement("div");
            newCreatDiv.style.margin = "0px 2px";
            newCreatDiv.style.padding = "4px 4px";
            ...
            newCreatDiv.appendChild(creaimage);
            newCreatDiv.appendChild(para);
            document.querySelector(".allWesternMovie").appendChild(newCreatDiv);

        });
    }

    actionMov(); adventureMov(); animationMov(); biographyMov(); comedyMov(); crimeMov(); dramaMov(); filmnoirMov(); familyMov(); fantasyMov(); historyMov(); horrorMov(); musicMov(); mysteryMov(); romanceMov(); scifiMov(); thrillerMov(); warMov(); westernMov();
...
document.getElementById("filmnoir").addEventListener("click", () => {
    let right = document.getElementById("rightSide");
    right.innerHTML = "";
...
async function loadAllMovie() {
    ...
    let btn1 = document.getElementById("sortRank");
    btn1.addEventListener("click", () => {
        ...
        ball.style.color = "white";
        let parehead = document.createElement("p");
        parehead.innerHTML = "Movies Rank 1 to 100"
        parehead.style.fontSize = "20px";
        right.appendChild(parehead);
...
async function movieSortAsc() {
    let user = [...allMoviesAllData];

    let btn2 = document.getElementById("sortByAsc");
    btn2.addEventListener("click", () => {
        ...
        ball.style.color = "white";
        let parehead = document.createElement("p");
        parehead.innerHTML = "Movies sort by Ascending order"
        parehead.style.fontSize = "20px";
        right.appendChild(parehead);

        user.sort((a, b) => (a.title > b.title) ? 1 : ((b.title > a.title) ? -1 : 0));
        ...
        user.forEach((def) => {
            ...
            // document.querySelector("#aa1").setAttribute("src" , def.thumbnail)
            // document.querySelector("#aa1").setAttribute("width" , "60px")
            // document.querySelector("#aa1").setAttribute("height" , "60px")
            // document.querySelector("#aa2").innerHTML = document.querySelector("#aa2").innerHTML + def.title
            // document.querySelector("#aa3").innerHTML = document.querySelector("#aa3").innerHTML + def.year
            // document.querySelector("#aa4").innerHTML = document.querySelector("#aa4").innerHTML + def.rating
            // document.querySelector("#aa5").innerHTML = document.querySelector("#aa5").innerHTML + def.description
            // document.querySelector("#aa6").setAttribute("href" , def.imdb_link)
    ...
    let btn3 = document.getElementById("sortByDes");
    btn3.addEventListener("click", () => {
        ...
        ball.style.color = "white";
        let parehead = document.createElement("p");
        parehead.innerHTML = "Movies sort by Descending order"
        parehead.style.fontSize = "20px";
        right.appendChild(parehead);
...
async function movieSortYear() {
    let user = [...allMoviesAllData];

    let btn3 = document.getElementById("sortRele");
    btn3.addEventListener("click", () => {
        ...
        ball.style.padding = "27px 27px"
        ball.style.backgroundColor = "rgb(40, 40, 40)"
        ball.setAttribute("class", "grid-container1");
        ball.style.color = "white";
        let parehead = document.createElement("p");
        parehead.innerHTML = "Movies sort by Release years"
        parehead.style.fontSize = "20px";
        right.appendChild(parehead);


        user.sort((a, b) => (a.year > b.year) ? 1 : ((b.year > a.year) ? -1 : 0));
        ...
        user.forEach((def) => {
            ...
            newCreatDiv.addEventListener("mouseover", movinDetail)



            function movinDetail() {

                let exam = document.createElement("div")
                exam.className = "ankRan";
                exam.style.width = "330px"
                exam.style.height = "440px"
                exam.style.backgroundColor = "rgb(90, 90, 90)";
                exam.style.position = "fixed";
                exam.style.top = "165px";
                exam.style.right = "30px";
                ...
                movImd.innerHTML = movImd.innerHTML + def.rank
                ...
                movyear.innerHTML = movyear.innerHTML + def.year

                let movrating = document.createElement("h6");
                movrating.innerHTML = "<span class='cccc1'>Rating:</span>  "
                movrating.innerHTML = movrating.innerHTML + def.rating
